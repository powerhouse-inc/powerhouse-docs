...
interface IReactorClient {
   ...
   */
  addOperations<TDocument extends PHDocument>(
   ...
   * @returns The job
   */
  submitOperations<TDocument extends PHDocument>(
    documentIdentifier: string,
    operations: Operation[],
    view?: ViewFilter,
  ): Promise<JobId>;
   ...
   * 
   * @param parentIdentifiers - Parent document identifiers
   ...
   * 
   * @param sourceParentId - Source parent document id or slug
   * @param targetParentId - Target parent document id or slug
