...
<div className={styles.learningPath}>
  ...
  <div className={styles.pathCard}>
    ...
    <div className={styles.cardContent}>
      <a href="/docs//bookofpowerhouse/Overview.md" className="path-button">The vision of Powerhouse</a>
    </div>
  </div>
  ...
  <div className={styles.pathCard} style={{ border: '1px solid #4FC86F' }}>
    ...
    <div className={styles.cardContent}>
      <a href="/docs/academy/BuildingUserExperiences/BuildToDoListEditor" className="path-button">Building ToDoList Editor</a>
