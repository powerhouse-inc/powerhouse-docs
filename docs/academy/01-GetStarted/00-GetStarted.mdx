...
<div className={styles.learningPath}>
  ...
  <div className={styles.pathCard} style={{ border: '1px solid #4FC86F' }}>
    ...
    <div className={styles.cardContent}>
      <a href="/docs/academy/BuildingUserExperiences/BuildToDoListEditor" className="path-button">Building a Todo-list Editor</a>
      ...
      <a href="/docs/academy/BuildingUserExperiences/BuildingADriveExplorer" className="path-button">Building Custom Drive Explorers</a>
    </div>
  </div>
  ...
  <div className={styles.pathCard} style={{ border: '1px solid #4FC86F' }}>
    ...
    <div className={styles.cardContent}>
      <a href="/docs/academy/WorkWithData/ReadingAndWritingThroughTheAPI" className="path-button">Reading & Writing through the API</a>
      <a href="/docs/academy/WorkWithData/WorkingWithSubgraphs" className="path-button">Create your own Subgraph</a>
  ...
  <div className={`${styles.pathCard} ${styles.fullWidth}`}>
    ...
    <div className={styles.cardContent}>
      <div className={styles.buttonContainer}>
        <a href="/docs/academy/Launch/PublishYourProject" className="path-button">Package & Publish</a>
  ...
  <div className={styles.pathCard}>
    ...
    <div className={styles.cardContent}>
      <a href="/docs/academy/Cookbook/PowerhouseRecipes" className="path-button">Powerhouse Recipes</a>
    </div>
  </div>
  ...
  <div className={styles.pathCard}>
    ...
    <div className={styles.cardContent}>
      <a href="/docs/academy/AdvancedTopics/PowerhouseArchitecture" className="path-button">Learn More</a>
    </div>
  </div>
</div>